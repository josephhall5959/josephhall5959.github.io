...
\centering\includegraphics[width=\textwidth,height=0.42\textheight,keepaspectratio]{figures/fig_geo_correlates.pdf}
\begin{itemize}\small
...
\m{A rate by place. Net of the auto collection rules the state ratios stay outside the range (30 of 50); in place-by-score-tercile cells with the place fixed at the borrower's first loan, 34 of 96 state cells lie inside, the Northeast and Florida with rates and the South with bounds. Within tercile the term response is highest where the vote is Republican and lowest on the West Coast, beyond the bound in both directions.}
