...
Table \ref{tab:rho_within} & The rate across people from the within-borrower design & \texttt{Code/identification/I6f\_within\_person\_by\_group.R, Code/identification/I6i\_within\_person\_by\_period.R, Code/local/within\_reading.R} & -- \\
...
Table \ref{tab:strategies} & Identification strategies for the discount rate: the record & -- & \texttt{the record of the designs, written from the memos and results named in each row}; \texttt{no generator} \\
