...
\input{version_date}   % written by publish_draft.sh on each publish; the date is the publish date, not the compile date
\begin{document}
...
\input{sections/external_experiments}
\input{sections/bureau}
\input{sections/rate_people}
\input{sections/term_margin}
\input{sections/equity}
\input{sections/liquidity}
...
\subsection{Proofs of the provisos and of the term-margin decomposition}\label{appendix:limits}
...
\small
\resizebox{\textwidth}{!}{\input{tables/tab_mc_runoff_grid}}
\vspace{0.5em}
...
\small
\input{tables/tab_mc_runoff_grid2}
\vspace{0.5em}
...
\small
\input{tables/tab_persistent_extract}
\vspace{0.5em}
\begin{minipage}{0.92\textwidth}
...
\scriptsize
\resizebox{\textwidth}{!}{\input{tables/tab_rho_variance}}
\vspace{0.5em}
...
\input{appendix_priority}

\input{appendix_bridge}

\input{appendix_data_issues}

\input{appendix_timing}
...
\small
\resizebox{\textwidth}{!}{\input{tables/tab_rho_within}}
\vspace{0.5em}
\begin{minipage}{0.92\textwidth}
...
\label{tab:exposure}
\small
\resizebox{\textwidth}{!}{\input{tables/tab_exposure}}
\vspace{0.5em}
\begin{minipage}{0.92\textwidth}
...
\label{tab:het_geo}
\scriptsize
\resizebox{\textwidth}{!}{\input{tables/tab_het_geo}}
\vspace{0.5em}
\begin{minipage}{0.95\textwidth}
...
\input{appendix_ladder}
\input{appendix_place}

\input{appendix_experiments}

\input{appendix_strategies}

\input{appendix_iv_validation}
...
\input{appendix_cards}

\input{appendix_equity}
...
\input{tables/tab_replication_map}
\end{footnotesize}
