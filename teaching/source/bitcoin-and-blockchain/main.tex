...
%\begin{frame}
%\frametitle{Technological Improvements}

%\begin{center}
%\includegraphics[width = \textwidth]{pics/asicprice.jpeg}
%\end{center}
...
\ei \pause
%\m But, mining rewards decrease every 5 years
%\pause
...
\m But, it's free \$\$!
\ei
%\m Gets slightly more complicated later: we'll discuss MEV\ldots
\ei
...
%\m Special ``coinbase'' tx, sends ``mined'' BTC to miner address
\ei
