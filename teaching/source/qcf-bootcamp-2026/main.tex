...
\begin{center}
\href{https://coinmarketcap.com/currencies/bitcoin/}{\includegraphics[width = .8\textwidth]{fig_btc_price_full.png}}
\end{center}
...
\begin{center}
\href{https://www.blockchain.com/explorer/charts/difficulty}{\includegraphics[width = .85\textwidth]{fig_btc_difficulty.png}}
\end{center}
...
\m The chart you just saw is where the two definitions part ways. Zero supply inflation in a growing economy is not zero price inflation -- it is \textbf{deflation} -- which punishes borrowers and depresses investment, and with it, growth
\ei
...
\begin{frame}
\frametitle{The Issuer Runs a Bank's Balance Sheet}
\begin{columns}
...
\m None of these economics will confuse anyone who knows leverage and macroprudential regulation, deposit insurance, or banking crises
\ei
...
\m Terra's \$50B collapse in three days was a classic run led by large sophisticated holders (Liu, Makarov \& Schoar, NBER 2023); stablecoins behave like uninsured money-market funds under stress (Anadu et al.\ 2023; Luck, ``Historical Perspective on Stablecoins,'' 2025)
\ei
