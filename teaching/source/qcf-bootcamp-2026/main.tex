...
\end{center}
\vspace{-1mm}
{\small A hard-capped money supply in an exponentially growing economy forces \textbf{deflation} -- gold's fatal flaw as a currency, and Bitcoin's 21M cap is the hardest gold ever designed. Great store-of-value story; poor medium of exchange and unit of account.}
\end{frame}
